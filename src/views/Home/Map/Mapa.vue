<template>
  <CargarMapa :configMapa="configMapa" apiKey="">

    <template slot-scope="{ google, map }">
      <Marcadores v-for="marker in markers" :key="marker.id" :marker="marker" :google="google" :map="map" />
    </template>
...
import CargarMapa from "./CargarMapa.vue";
